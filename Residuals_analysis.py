...
for file in files:
    ...
    for low_pass_filter_frequency in  list_of_frequencies:
        ...
        rms_2 = RMS(Performance_1, Performance_1_filtered)
        rms_3 = RMS(Performance_1, Performance_1_filtered)
        rms_4 = RMS(Performance_1, Performance_1_filtered)
        rms_5 = RMS(Performance_1, Performance_1_filtered)
        rms_6 = RMS(Performance_1, Performance_1_filtered)
        rms_7 = RMS(Performance_1, Performance_1_filtered)
        rms_8 = RMS(Performance_1, Performance_1_filtered)
        rms_9 = RMS(Performance_1, Performance_1_filtered)
        rms_10 = RMS(Performance_1, Performance_1_filtered)
    ...
    save_dir = r"C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Grip training\Pilot study 4\Results\Residual analysis"
