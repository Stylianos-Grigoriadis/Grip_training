...
for file in files:
    ...
    time_to_adapt_before_down_1_sd, time_to_adapt_before_down_1_asymp = lb.adaptation_time_using_sd_from_isometric_trials_and_asymptotes(
        Perturbation_before_down_1, sd_factor, time_window, ID, mean_spatial_error_10, sd_spatial_error_10,
        asymptote_fraction=asymptote_fraction, plot='None')
